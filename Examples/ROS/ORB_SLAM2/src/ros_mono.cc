...
int main(int argc, char **argv)
{
    ...
    // Stop all threads
    SLAM.Shutdown();
    cout << "Returned from Shutdown" << endl;
    // Save camera trajectory
    SLAM.SaveKeyFrameTrajectoryTUM("KeyFrameTrajectory.txt");
    cout << "Camera Trajectory saved" << endl;
    ros::shutdown();
    cout << "ROS Shutdown successful" << endl;
    return 0;
}
...
// Nehal and Min
bool matrixIsIdentity(pangolin::OpenGlMatrix &M)
{

    if(M.m[0] == 1.0 && M.m[1] == 0.0 && M.m[2] == 0.0 && M.m[3]  == 0.0 && M.m[4] == 0.0 && 
        M.m[5] == 1.0 && M.m[6] == 0.0 && M.m[7]  == 0.0 && M.m[8] == 0.0 && M.m[9] == 0.0 && M.m[10] == 1.0 && M.m[11]  == 0.0 && 
